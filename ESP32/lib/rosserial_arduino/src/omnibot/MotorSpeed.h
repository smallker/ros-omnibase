#ifndef _ROS_omnibot_MotorSpeed_h
#define _ROS_omnibot_MotorSpeed_h
...
namespace omnibot
{
  ...
  class MotorSpeed : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "omnibot/MotorSpeed"; };
    virtual const char * getMD5() override { return "d20f63a7e99cd5689c2dcf93cf2f8085"; };
